...
incident1 = Incident(incidentID = 1, raisedID = 'directory', affectedID = 'user', investigatingDepartmentID = 1, description = 'Something broke', timeRaised = datetime.datetime(2019,2,15,7,5), priority = 'priority', severity = 'severity', impact = 'impact', status = 'completed', timeCompleted = datetime.datetime(2019,3,4,6,4))
incident2 = Incident(incidentID = 2, raisedID = 'user', affectedID = 'user', investigatingDepartmentID = 1, description = 'Something broke', timeRaised = datetime.datetime(2019,2,20,9,50), priority = 'priority', severity = 'severity', impact = 'impact', status = 'completed', timeCompleted = datetime.datetime(2019,3,15,8,5))
incident3 = Incident(incidentID = 3, raisedID = 'prince', affectedID = 'user2', investigatingDepartmentID = 2, description = 'Something broke', timeRaised = datetime.datetime(2019,3,4,10,45), priority = 'priority', severity = 'severity', impact = 'impact', status = 'completed', timeCompleted = datetime.datetime(2019,5,15,7,5))
incident4 = Incident(incidentID = 4, raisedID = 'directory', affectedID = 'user3', investigatingDepartmentID = 2, description = 'Something broke', timeRaised = datetime.datetime(2019,3,30,13,50), priority = 'priority', severity = 'severity', impact = 'impact', status = 'completed', timeCompleted = datetime.datetime(2019,4,15,7,5))
incident5 = Incident(incidentID = 5, raisedID = 'prince', affectedID = 'user2', investigatingDepartmentID = 3, description = 'Something broke', timeRaised = datetime.datetime(2019,4,15,16,25), priority = 'priority', severity = 'severity', impact = 'impact', status = 'assigned', timeCompleted = None)
incident6 = Incident(incidentID = 6, raisedID = 'prince', affectedID = 'user', investigatingDepartmentID = 3, description = 'Something broke', timeRaised = datetime.datetime(2019,4,16,7,5), priority = 'priority', severity = 'severity', impact = 'impact', status = 'assigned', timeCompleted = None)
incident7 = Incident(incidentID = 7, raisedID = 'autonomy', affectedID = 'autonomy', investigatingDepartmentID = 4, description = 'Something broke', timeRaised = datetime.datetime(2019,5,18,10,30), priority = 'priority', severity = 'severity', impact = 'impact', status = 'assigned', timeCompleted = None)
incident8 = Incident(incidentID = 8, raisedID = 'mud', affectedID = 'mud', investigatingDepartmentID = 4, description = 'Something broke', timeRaised = datetime.datetime(2019,6,6,6,36), priority = 'priority', severity = 'severity', impact = 'impact', status = 'assigned', timeCompleted = None)
incident9 = Incident(incidentID = 9, raisedID = 'pour', affectedID = 'pour', investigatingDepartmentID = None, description = 'Something broke', timeRaised = datetime.datetime(2019,7,20,6,4), priority = 'priority', severity = 'severity', impact = 'impact', status = 'submited', timeCompleted = None)
incident10 = Incident(incidentID = 10, raisedID = 'tent', affectedID = 'tent', investigatingDepartmentID = None, description = 'Something broke', timeRaised = datetime.datetime(2019,9,2,7,50), priority = 'priority', severity = 'severity', impact = 'impact', status = 'submited', timeCompleted = None)
