...
incident9 = Incident(incidentID = 9, raisedID = 'pour', affectedID = 'pour', investigatingDepartmentID = 2, description = 'Something broke', timeRaised = datetime.datetime(2019,7,20,6,4), priority = 'P2', severity = 'S3', impact = 'impact', status = 'submited', timeCompleted = None)
incident10 = Incident(incidentID = 10, raisedID = 'tent', affectedID = 'tent', investigatingDepartmentID = 3, description = 'Something broke', timeRaised = datetime.datetime(2019,9,2,7,50), priority = 'P3', severity = 'S3', impact = 'impact', status = 'submited', timeCompleted = None)
